# SvarnaFiNexa Launch Checklist

## Domain and DNS

1. Add `svarnafinexa.in` to your Vercel project.
2. Add `www.svarnafinexa.in` as an alias if you want both hostnames covered.
...
2. Set the production domain to `svarnafinexa.in`.
...
1. Create `support@svarnafinexa.in` before launch.
...
3. Create backup inboxes if needed:
   - `hello@svarnafinexa.in`
   - `legal@svarnafinexa.in`
   - `admin@svarnafinexa.in`
